    ...
    for (int i = 0; i < _stackNum; i++) {
      ...
      switch (orientation) {
        case AmassOrientation.BOTTOM:
          _cardAligns.add(
              new Alignment(0.0, (0.6 / (_stackNum - 1)) * (stackNum - i)));
          break;
        ...
        case AmassOrientation.LEFT:
          _cardAligns.add(
              new Alignment((-0.6 / (_stackNum - 1)) * (stackNum - i), 0.0));
          break;
        case AmassOrientation.RIGHT:
          _cardAligns.add(
              new Alignment((0.6 / (_stackNum - 1)) * (stackNum - i), 0.3));
          break;
      }
    }
  }
...
class _TinderSwapCardState extends State<TinderSwapCard>
  ...
  changeCardOrder() {
    setState(() {
      _currentFront = _currentFront! - widget._stackNum;
      frontCardAlign = _cardAligns[widget._stackNum - 1];
    });
  }
}
